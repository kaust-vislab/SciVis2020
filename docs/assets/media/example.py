...
netCDFReader1 = NetCDFReader(FileName=['/Users/theusst/0001/COMBINED_2011013100.nc'])
netCDFReader1.Dimensions = '(Z_MIT40, YG, XC)'
netCDFReader1.SphericalCoordinates = 0

# create a new 'XDMF Reader'
xDMFReader1 = XDMFReader(FileNames=['/Users/theusst/0001/bathymetry.xmf'])
...
# create a new 'NetCDF Reader'
netCDFReader3 = NetCDFReader(FileName=['/Users/theusst/0001/COMBINED_2011013100.nc'])
netCDFReader3.Dimensions = '(Z_MIT40, YC, XG)'
netCDFReader3.SphericalCoordinates = 0

# create a new 'NetCDF Reader'
netCDFReader2 = NetCDFReader(FileName=['/Users/theusst/0001/COMBINED_2011013100.nc'])
